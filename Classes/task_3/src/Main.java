...
public class Main {
        ...
        while (true) {
            ...
            switch (option) {
                ...
                case "PCQ":
                    ...
                    severedCustomer(pump1,pump2,pump3,pump4,pump5,fuelStock);
                    break;
                case "105":
                case "VCS":
    ...
    private static void severedCustomer(passenger[] pump1,passenger[] pump2,passenger[] pump3,passenger[] pump4,passenger[] pump5,int[] fuelStock){
    ...
    public static void storeTOFile(passenger[] pump1,passenger[] pump2,passenger[] pump3,passenger[] pump4,passenger[] pump5,int[] fuelStock){
        try{
