...
public class Main {
    public static void main(String[] args) {
        passenger[] pump1 = new passenger[6];
        passenger[] pump2 = new passenger[6];
        passenger[] pump3 = new passenger[6];
        passenger[] pump4 = new passenger[6];
        passenger[] pump5 = new passenger[6];
        ...
        while (true) {
            ...
            switch (option) {
                ...
                case "VFQ":
                    ...
                    allQueues(pump1,pump2,pump3,pump4,pump5);
                    break;
                case "101":
                case "VEQ":
                    System.out.println("Empty Queues:");
                    emptyQueues(pump1,pump2,pump3,pump4,pump5);
                    break;
                case "102":
                case "ACQ":
                ...
                case "PCQ":
                    ...
                    severedCustomer(pump1,pump2,pump3,pump4,pump5);
                    break;
                case "105":
                case "VCS":
                    System.out.println("sorted list in alphabetical order");
                    alphabetical_order(pump1,pump2,pump3,pump4,pump5);
                    break;
                case "106":
                case "SPD":
                    System.out.println("You have successfully stored data into a file");
                    storeTOFile(pump1,pump2,pump3,pump4,pump5,fuelStock);
                    break;
                case "107":
                case "LPD":
    ...
    private static void allQueues(passenger[] pump1,passenger[] pump2,passenger[] pump3,passenger[] pump4,passenger[] pump5){
    ...
    private static void emptyQueues(passenger[] pump1,passenger[] pump2,passenger[] pump3,passenger[] pump4,passenger[] pump5){
        System.out.println("------------ Queue 1 --------------");
        for(int i=0;i<pump1.length;i++){
    ...
    private static void severedCustomer(passenger[] pump1,passenger[] pump2,passenger[] pump3,passenger[] pump4,passenger[] pump5){
        //Removing the served customer from the Queue
    ...
    private static void alphabetical_order(passenger[] pump1,passenger[] pump2,passenger[] pump3,passenger[] pump4,passenger[] pump5) { //method to display customer name in alphabetical oder
    ...
    private static void storeTOFile(passenger[] pump1,passenger[] pump2,passenger[] pump3,passenger[] pump4,passenger[] pump5,int[] fuelStock){
        try{
